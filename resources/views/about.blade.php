    ...
    <section class="py-24 bg-white dark:bg-[#0a0a0a]" id="team">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
                @foreach ([['Jawad Charles', 'Founder & CEO', 'The vision behind TapEventCard. Jawad built the first version after his own wedding logistics nightmare — and decided to solve it for everyone.', '#e8120a', 'J'], ['Twity Robert', 'Head of Design', 'Twity leads all Premium card designs. Her obsession with typography and composition ensures every invitation feels like a piece of art.', '#c41009', 'T'], ['Valentine Florentine', 'Tech Lead', 'Valentine built the platform from scratch — the automated delivery engine, QR verification system, and real-time dashboard are all his work.', '#a30d08', 'V']] as $i => $m)
